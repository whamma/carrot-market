...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <button className="mt-5 w-full bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white border border-transparent focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">Upload product</button>
    </div>
  );
};
